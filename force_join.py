...
# --- Configuration ---
GROUP_ID = -1003222060363       # numeric group ID (required)
GROUP_USERNAME = "wiz_x_chk"     # for join button (@username only)

CHANNEL_ID = -1003222060363    # numeric channel ID (required)
CHANNEL_USERNAME = "wiz_x_chk"  # for join button (no '+' sign)

# ✅ Updated permanent image link from ImgBB
FORCE_JOIN_IMAGE = "https://i.ibb.co/xSbxfGZH/ee6d1fc581abefe0d80bbe1577fc6533.jpg"
